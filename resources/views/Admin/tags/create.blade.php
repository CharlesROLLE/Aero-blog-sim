            ...
            <section class="relative flex flex-wrap lg:h-screen lg:items-center">
                <div class="w-full px-4 py-12 lg:w-1/2 sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                    <div class="max-w-lg mx-auto text-center">
                        <h1 class="text-2xl font-bold sm:text-3xl">Sigues avanzando!</h1>
                    ...
                    <form action="{{ route('admin.tags.store') }}" class="max-w-md mx-auto mt-8 mb-0 space-y-4"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="name" value="{{ old('name') }}"
                                    ...
                                    placeholder="Ingrese el nombre del tag" id="slug-source" />
                                @error('name')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="slug" value="{{ old('slug') }}" onfocus="Toslug()"
                                    class="w-full p-4 pr-12 text-sm border-gray-200 rounded-lg shadow-sm"
